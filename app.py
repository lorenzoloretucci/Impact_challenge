...
def update_map(n):
    ...
    for i, p in enumerate(POSITIONS):
        if i not in bins_full:
            folium.Marker(location=[p[0], p[1]],
                        icon = folium.features.CustomIcon("https://github.com/lorenzoloretucci/Impact_challenge/blob/horeku/assets/dustbin.png?raw=true",
                                                        icon_size=(20, 20)),
                                                        popup=f'Garbage bin #{int(i)}'
                        ).add_to(rome_map)
        else:
            folium.Marker(location=[p[0], p[1]],
                        icon = folium.features.CustomIcon( "https://github.com/lorenzoloretucci/Impact_challenge/blob/horeku/assets/bluebin.png?raw=true",
                                                        icon_size=(20, 20)),
                                                        popup=f'Garbage bin #{int(i)}'
                        ).add_to(rome_map)
    ...
    for pos in active_trucks_pos:
        folium.Marker(location=[pos[1], pos[2]],
                                icon = folium.features.CustomIcon( "https://github.com/lorenzoloretucci/Impact_challenge/blob/horeku/assets/garbagetruck.png?raw=true",
                                                                icon_size=(35, 35)),
    ...
    for pos in inactive_trucks_pos:
        folium.Marker(location=[pos[1], pos[2]],
                                icon = folium.features.CustomIcon( "https://github.com/lorenzoloretucci/Impact_challenge/blob/horeku/assets/garbagetruck_off.png?raw=true",
                                                                icon_size=(35, 35)),
                                                                popup=f'Garbage truck #{int(pos[0] + 1)}'
                    ).add_to(rome_map)
